...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    private String[] title = {"Mua sắm dễ dàng chỉ với smartphone", "Lựa chọn sản phẩm và thanh toán","Nhận hàng"};
    private String[] description = {"Now you can get groceries item at your doorstep.",
            "Dummy text is text that is used in the publishing industry or by web designers to occupy the space",
            "Explore and order your favourite grocery items."};
